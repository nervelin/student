...
<div id="Popup">
    ...
    <div id="SubPopup">
        ...
        <div class="form_boxC">
            ...
            <form action="${pageContext.request.contextPath}/student_updateStudent.action" method="post">
                <table cellpadding="0" cellspacing="0">
                    <input type="hidden" name="id" value="${student.id}">
                    <tr>
                        <th>学生姓名<span class="f_cB">*</span></th>
                        <td><div class="txtbox floatL" style="width:100px;"><input name="studentname" type="text" size="5" value="${student.studentname}"></div></td>
                    </tr>
                    <tr>
                        <th>性别<span class="f_cB">*</span></th>
                        <td><div class="txtbox floatL" style="width:100px;"><input name="sex" type="text" size="5" value="${student.sex}"></div></td>
                    </tr>
                    <tr>
                        <th>专业<span class="f_cB">*</span></th>
                        <td><div class="txtbox floatL" style="width:100px;"><input name="major" type="text" size="5" value="${student.major}"></div></td>
                    </tr>
                    <tr>
                        <th>电话<span class="f_cB">*</span></th>
                        <td><div class="txtbox floatL" style="width:100px;"><input name="phone" type="text" size="5" value="${student.phone}"></div></td>
                    </tr>
                    <tr>
                        <th>学院号<span class="f_cB">*</span></th>
                        <td><div class="txtbox floatL" style="width:100px;"><input name="college.id" type="text" size="5" value="${student.college.id}"></div></td>
                    </tr>
                </table>
        </div>
    </div>
