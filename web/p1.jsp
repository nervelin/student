...
<div id="Popup">
    ...
    <div id="SubPopup">
        ...
        <div class="form_boxC">
            ...
            <form action="${pageContext.request.contextPath}/college_addCollege.action" method="post">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <th>学院名称<span class="f_cB">*</span></th>
                        <td><div class="txtbox floatL" style="width:100px;"><input name="collegename" type="text" size="5" value=""></div></td>
                    </tr>
                    <tr>
                        <th>学院概况</th>
                        <td><div class="txtbox"><textarea name="describes" cols="25" rows="5"></textarea></div><p class="f_cB pdg_t5">最多500字</p></td>
                    </tr>
                </table>
        </div>
    </div>
    ...
    <div id="BtmBtn">
        <div class="btn_boxB floatR mag_l20">
            <input name="" type="button" value="取消" onmousemove="this.className='input_move'" onmouseout="this.className='input_out'">
        </div>
